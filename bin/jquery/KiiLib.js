...
(function (Kii) {
    var KiiCondition = (function () {
        function KiiCondition(clause) {
            this.clause = clause;
            this.orderBy = null;
        ...
        KiiCondition.prototype.sortByAsc = function (field) {
            this.orderBy = field;
            this.descending = false;
        };

        KiiCondition.prototype.sortByDesc = function (field) {
            this.orderBy = field;
            this.descending = true;
        };

        KiiCondition.prototype.setLimit = function (limit) {
            this.limit = limit;
        };

        KiiCondition.prototype.setPaginationKey = function (key) {
        ...
        KiiCondition.prototype.hasNext = function () {
            return this.paginationKey != null;
        };

        KiiCondition.prototype.toJson = function () {
            var query = {
...
(function (Kii) {
    var KiiUserAPI = (function () {
        ...
        KiiUserAPI.prototype.resetPassword = function (user, callback) {
            var c = this.context;
            var url = c.getServerUrl() + '/apps/' + c.getAppId() + user.getPath() + '/password/reset';
...
(function (Kii) {
    var KiiBucketAPI = (function () {
        ...
        KiiBucketAPI.prototype.query = function (bucket, condition, callback) {
            var c = this.context;
